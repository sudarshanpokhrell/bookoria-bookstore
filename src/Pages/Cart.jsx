    ...
    <div className="cart-page">
        ...
        cart.map((item, index) => (
          <div className="cart-item" key={index}>
            ...
            <div className="cart-item-quantity">
              ...
              <MdDeleteForever onClick={() => removeFromCart(item.bookID)} className="cart-delete" />
            </div>
      ...
      <div className="checkout-summary">
        <div className="checkout-total">
          ...
          <p className="checkout-amount">$ {totalAmount.toFixed(2)}</p> {/* Replace with actual total calculation */}
        </div>
        <p className="checkout-details">
          Taxes, discounts, and <span className="checkout-link">shipping</span>{" "}
